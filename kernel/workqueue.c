...
#ifdef CONFIG_MACH_OPPO //yixue.ge@BSP.drv add kernel  patch for  workqueue: fix hang involving racing cancel[_delayed]_work_sync()'s for PREEMPT_NONE
struct cwt_wait {
	wait_queue_t		wait;
	struct work_struct	*work;
};
...
static bool __cancel_work_timer(struct work_struct *work, bool is_dwork)
{
	...
	do {
		...
		#ifndef CONFIG_MACH_OPPO //yixue.ge@BSP.drv add kernel  patch for  workqueue: fix hang involving racing cancel[_delayed]_work_sync()'s for PREEMPT_NONE
		/*
